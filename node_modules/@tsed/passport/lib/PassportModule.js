...
let PassportModule = class PassportModule {
    ...
    $onInit() {
        ...
        this.protocolsService.getProtocols().forEach((provider) => this.protocolsService.invoke(provider));
        return undefined;
    }
    $beforeRoutesInit() {
        ...
        switch (this.platformName) {
            case "express":
                ...
                this.app.use(passport_1.default.session({ pauseStream }));
                return;
            default:
...
tslib_1.__decorate([
    common_1.Constant("passport.userProperty"),
    tslib_1.__metadata("design:type", String)
], PassportModule.prototype, "userProperty", void 0);
tslib_1.__decorate([
    common_1.Constant("passport.pauseStream"),
    tslib_1.__metadata("design:type", Boolean)
], PassportModule.prototype, "pauseStream", void 0);
tslib_1.__decorate([
    common_1.Constant("PLATFORM_NAME"),
    tslib_1.__metadata("design:type", String)
