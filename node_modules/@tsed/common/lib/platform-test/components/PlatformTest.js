...
class PlatformTest extends di_1.DITest {
    static async create(options = {}) {
        ...
        const container = di_1.createContainer();
        await di_1.DITest.injector.load(container, platform_1.PlatformModule);
    }
    /**
     * Create a new injector with the right default services
     */
    static createInjector(settings = {}) {
        return platform_1.createInjector(di_1.DITest.configure(settings));
    }
    /**
    ...
    static bootstrap(mod, settings = {}) {
        return async function before() {
            ...
            // @ts-ignore
            instance = await platform_1.PlatformBuilder.build(platform).bootstrap(mod, di_1.DITest.configure(settings));
            if (!settings.listen) {
